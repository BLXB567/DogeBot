...
const asw1 = 'https://i.ibb.co/tXcDzhP/xeon.jpg'
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6283117436733@s.whatsapp.net`,`6282327759039@s.whatsapp.net`]
...
"mediaType": "2",
"thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
"mediaUrl": "https://instagram.com/xkurokochi_",
...
*「  Mayumi DVT  」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered Renge ~Bot*`)
		}, 2000)
        break
...
case 'owner':
           case 'creator':
               ...
               buttons = [{buttonId:`iggw`,buttonText:{displayText:'INSTAGRAM'},type:1}]
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://instagram.com/xkurokochi_"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply('Only owner can use this feature')
        xeon.toggleDisappearingMessages(from, 0)
...
sendButMessage(from, tiyo, `Renge ~Bot`, [
            {              
